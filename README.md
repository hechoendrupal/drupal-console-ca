# drupal-console-ca
DrupalConsole Catalan Language / en català
...
```
$ composer require drupal/console-ca
```
...
- Fork this repository following this link [https://github.com/hechoendrupal/drupal-console-ca#fork-destination-box](https://github.com/hechoendrupal/drupal-console-ca#fork-destination-box)
...
```
$ git remote add upstream git@github.com:hechoendrupal/drupal-console-ca.git
```
